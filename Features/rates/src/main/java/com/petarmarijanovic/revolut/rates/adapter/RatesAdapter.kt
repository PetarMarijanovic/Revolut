...
class RatesAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RateViewHolder =
            RateViewHolder(layoutInflater.inflate(LAYOUT, parent, false), onRateClickListener)
    ...
    override fun onBindViewHolder(holderRate: RateViewHolder, position: Int, payloads: MutableList<Any>) {
        ...
        payloads.filterIsInstance<Pair<RatesViewModel, RatesViewModel>>().forEach { holderRate.renderUpdate(it.second) }
    }
